...
/****** Object:  Database [efdb]    Script Date: 1/20/2023 8:27:45 PM ******/
CREATE DATABASE [efdb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'efdb', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.NIRJONSQL\MSSQL\DATA\efdb.mdf' , SIZE = 3136KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'efdb_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.NIRJONSQL\MSSQL\DATA\efdb_log.ldf' , SIZE = 784KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
